...
namespace Polenter.Serialization
{
    ...
    public sealed class SharpSerializer
    {
        ...
        public Property _xmlProperty { get; set; }
        ...
        public SharpSerializer(AdvancedSharpSerializerXmlSettings settings)
        {
            _propertyProvider = new PropertyProvider();
            SharpSerializerXmlSettings ShSerSettings = new SharpSerializerXmlSettings();
            ShSerSettings.AdvancedSettings = settings;
            initialize(ShSerSettings);
        }
