        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                do
                {
                    ...
                    string[] arDCAChannelName = null; 
                    ret = _client.getInstrumentLockWithReturn(sharedInstrument.DCA, sThreadID, sMachineName, ref WCFDCA, ref WCFProtocol, nChannelInEachMeasurementGroup, ref arDCAChannelName);
