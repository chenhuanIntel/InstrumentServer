        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                do
                {
                    ...
                    Console.WriteLine($"Thread={ThreadID} Add({a}, {b}) = {sum.ToString()}\n");
                    ...
                    ret = _client.getInstrumentLock(InstrumentLockServiceFacadeClient.sharedInstrument.DCA, ThreadID);
                    ...
                    ret = _client.releaseInstrumentLock(InstrumentLockServiceFacadeClient.sharedInstrument.DCA, ThreadID);
                    Console.WriteLine($"Thread={ThreadID} releaseInstrumentLock(sharedInstrument.DCA)\n");

                    ret = _client.getProtocolLock(InstrumentLockServiceFacadeClient.sharedProtocol.DiCon, ThreadID);
                    ...
                    ret = _client.releaseProtocolLock(InstrumentLockServiceFacadeClient.sharedProtocol.DiCon, ThreadID);
